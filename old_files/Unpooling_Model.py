...
def train(duration, epochs, batch_size,
          pooling, unpooling, loss, edge_finder, resize: bool, dim_input, kernel_size,
    ...
    epoch, batch_diff, loss_tracker = 0, [], []
    while learn_rate >= end_lr or epoch < epochs:
        for i in range(batch_size):
            original, gradient, target = produce_image(15, sp_prob=0.00, dim=dim_input,
                                                       grad=edge_finder)
