...
lossf = [nn.BCEWithLogitsLoss, nn.MSELoss, weighted_mse_loss]  # "CUSTOM", "DICE"
lo = ["BCE", "MSE", "weighted_mse_loss"]
kernel_size = [1, 3, 5]
...
models_results.to_csv("ModelsTransposed.csv")
